...
public class TC01_Add_Skills {
  ...
  public void SkillsTest() throws Exception {
	  ...
	  findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[2]")).sendKeys("Java15");
	  findElement(By.xpath("//textarea[@placeholder='Type description here']")).sendKeys("Java15 descr");
