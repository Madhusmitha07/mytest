		...
		public void File_upload()throws Exception
		  {
			...
			//SendKeys
				...
				findElement(By.xpath("//button[@type='submit']")).click();
			 	...
			 	findElement(By.xpath("//input[@placeholder='First Name']")).sendKeys("mahesh");
			 	findElement(By.xpath("//input[@placeholder='Middle Name']")).sendKeys("reddy");
			 	findElement(By.xpath("//input[@placeholder='Last Name']")).sendKeys("tamma");
			 	findElement(By.xpath("(//input[@class='oxd-input oxd-input--active'])[2]")).sendKeys("1233");
			 	
			 	 
			 	 String str1="C:\\Users\\mahes\\OneDrive\\Desktop\\prabhas.jpeg";
			 	 PhotoUpload(str1);
		        findElement(By.xpath("//button[@type='submit']")).click();
